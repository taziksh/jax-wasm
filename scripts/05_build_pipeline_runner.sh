...
# The verified lowering pipeline (index width pinned to 32 for wasm32).
PIPELINE='builtin.module(func.func(stablehlo-legalize-to-linalg),one-shot-bufferize{bufferize-function-boundaries},func.func(convert-linalg-to-loops),convert-scf-to-cf,finalize-memref-to-llvm{index-bitwidth=32},convert-func-to-llvm{index-bitwidth=32},convert-arith-to-llvm{index-bitwidth=32},convert-math-to-llvm,convert-cf-to-llvm{index-bitwidth=32},reconcile-unrealized-casts)'
